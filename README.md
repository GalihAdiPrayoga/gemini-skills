...
Dikelola secara privat oleh **Muhammad Galih Adi Prayoga** ([@GalihAdiPrayoga](https://github.com/GalihAdiPrayoga)).
Semua berkas kredensial dan data sensitif dikecualikan melalui `.gitignore`.
