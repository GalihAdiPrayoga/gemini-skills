...
STACK_CONFIG = {
    ...
    "framer-motion":    {"file": "stacks/framer-motion.csv"},
}
...
STACK_CURRENT_APPLICABILITY = {
    ...
    "framer-motion": "framer-motion 12.x / motion 12",
}
...
_STACK_QUERY_NAMES = {
    ...
    "laravel": r"laravel",
    "framer-motion": r"framer(?:[\s-]*motion)?|motion/react",
}
